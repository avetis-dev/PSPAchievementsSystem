...
#define PACH_ACHIEVEMENT_MAX             192u
#define PACH_ACHIEVEMENT_TITLE_CAPACITY   64u
#define PACH_ACHIEVEMENT_GROUP_MAX       512u
#define PACH_ACHIEVEMENT_CONDITION_MAX 12288u
#define PACH_ACHIEVEMENT_OPERAND_MAX    (PACH_ACHIEVEMENT_CONDITION_MAX * 2u)
#define PACH_ACHIEVEMENT_STRING_MAX    32768u
#define PACH_ACHIEVEMENT_SAMPLE_CACHE_MAX 1024u
#define PACH_ACHIEVEMENT_SCHEDULER_WATCH_MAX 16u
#define PACH_ACHIEVEMENT_SCHEDULER_CYCLE 96u

#define PACH_OPERAND_MEMORY_INDEX_NONE 0xFFFFu
#define PACH_OPERAND_DIVISOR_MIN            2u
#define PACH_OPERAND_DIVISOR_MAX        0x7FFFu
